...
import type { ChannelShare } from '../data/mock'
  ...
  return (
    <div className="card">
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 11, color: 'var(--ink3)', fontFamily: 'DM Mono, monospace' }}>este mes</span>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ height: 160, position: 'relative' }}>
          <Doughnut
            ...
            aria-label="Distribución de canales de adquisición"
          />
          {/* Center label */}
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center' }}>
            <div style={{ fontSize: 20, fontWeight: 600, fontFamily: 'DM Mono, monospace', color: 'var(--ink)', lineHeight: 1 }}>84.2k</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {channels.map(ch => (
            <div key={ch.name} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12 }}>
              ...
              <span style={{ fontFamily: 'DM Mono, monospace', fontWeight: 500, color: 'var(--ink)', width: 28, textAlign: 'right' }}>
                {ch.pct}%
              </span>
            </div>
          ))}
