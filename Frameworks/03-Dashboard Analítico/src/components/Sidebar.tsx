...
const IconFunnel = () => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width={15} height={15}>
    <circle cx="8" cy="8" r="6"/><line x1="8" y1="4" x2="8" y2="8"/><line x1="8" y1="8" x2="11" y2="10"/>
  </svg>
)
const IconReport = () => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width={15} height={15}>
    <rect x="2" y="3" width="12" height="10" rx="1"/><line x1="2" y1="7" x2="14" y2="7"/><line x1="6" y1="7" x2="6" y2="13"/>
  </svg>
)
const IconUser = () => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width={15} height={15}>
...
const IconMail = () => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width={15} height={15}>
    <rect x="1" y="4" width="14" height="9" rx="1"/><polyline points="1,5 8,10 15,5"/>
  </svg>
)
const IconCart = () => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" width={15} height={15}>
    <path d="M3 3h10l1 8H2L3 3z"/><circle cx="6" cy="13" r="1"/><circle cx="11" cy="13" r="1"/>
  </svg>
)
...
export function Sidebar() {
  ...
  return (
    <aside style={{
      background: 'var(--surf)', borderRight: '0.5px solid var(--border2)',
      ...
      <div style={{ padding: '20px 20px 16px', borderBottom: '0.5px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 10, color: 'var(--ink3)', fontFamily: 'DM Mono, monospace' }}>v1.0 · fase 1</div>
        </div>
      </div>
      ...
      <div style={{ padding: '14px 12px', borderTop: '0.5px solid var(--border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          ...
          <div>
            <p style={{ fontSize: 12, fontWeight: 500, color: 'var(--ink)' }}>Ana K.</p>
            <span style={{ fontSize: 10, color: 'var(--ink3)', fontFamily: 'DM Mono, monospace' }}>admin · free plan</span>
          </div>
        </div>
      </div>
    </aside>
...
function NavSection({ label, links, active, onSelect }: {
  label: string
  links: NavLink[]
  active: NavItem
  ...
  return (
    <>
      ...
      {links.map(link => (
        <div
          key={link.id}
          className={clsx('nav-item', { active: active === link.id })}
